...
const INVENTORY_NAV = [
    ...
    { id: 'exits',       label: 'Saídas',            icon: 'fa-arrow-right-from-bracket', href: 'exits.html',   disabled: true, badge: 'F2' },
    { id: 'transfers',   label: 'Transferências',    icon: 'fa-right-left',  href: 'transfers.html', disabled: true, badge: 'F2' },
    { id: 'adjustments', label: 'Ajustes',           icon: 'fa-sliders',     href: 'adjustments.html', disabled: true, badge: 'F2' },
